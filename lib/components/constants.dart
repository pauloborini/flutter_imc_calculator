...
const Color yellowLight = Color.fromARGB(255, 251, 255, 174);
const Color redLight = Color.fromARGB(255, 250, 195, 195);
const Color greenLight = Color.fromARGB(255, 219, 241, 193);
const Color blueLight = Color.fromARGB(255, 193, 219, 241);
const Color blueAccentLight = Color.fromARGB(255, 157, 255, 246);
const Color colorGreen = Color.fromARGB(255, 117, 224, 53);
const Color colorRed = Color.fromARGB(255, 222, 55, 55);
